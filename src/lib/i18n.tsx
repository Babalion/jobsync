...
const translations: Record<SupportedLanguage, Record<string, string>> = {
  en: {
    ...
    "Suggest ZIP": "Suggest ZIP",
    "Could not find a ZIP code. Please enter manually.":
      "Could not find a ZIP code. Please enter manually.",
  ...
  de: {
    ...
    "Career Site": "Karriereseite",
    Locations: "Standorte",
    "No locations available": "Keine Standorte vorhanden",
    ...
    "Zip / Postal Code": "PLZ",
    "Suggest ZIP": "PLZ vorschlagen",
    "Could not find a ZIP code. Please enter manually.":
      "Keine PLZ gefunden. Bitte manuell eintragen.",
